...
void StopCMS3::GetEntry(unsigned int idx) 
	...
	// load all branches
{
	...
	const unsigned int &StopCMS3::run()
	{
		if (not run_isLoaded) {
			if (run_branch != 0) {
	...
	const unsigned int &StopCMS3::ls()
	{
		if (not ls_isLoaded) {
			if (ls_branch != 0) {
	...
	const unsigned int &StopCMS3::evt()
	{
		if (not evt_isLoaded) {
			if (evt_branch != 0) {
	...
	const float &StopCMS3::pfmet_phi()
	{
	...
	const float &StopCMS3::pfmet_phi_rl()
	{
	...
	const float &StopCMS3::xsec_uncert()
	{
	...
	const string &StopCMS3::filename()
	{
	...
	const unsigned int &StopCMS3::nEvents()
	{
	...
	const unsigned int &StopCMS3::nEvents_goodvtx()
	{
	...
	const unsigned int &StopCMS3::nEvents_MET30()
	{
	...
	const unsigned int &StopCMS3::nEvents_1goodlep()
	{
	...
	const unsigned int &StopCMS3::nEvents_2goodjets()
	{
	...
	const int &StopCMS3::is1lepFromW()
	{
	...
	const int &StopCMS3::is1lepFromTop()
	{
	...
	const float &StopCMS3::mindphi_met_j1_j2()
	{
	...
	const float &StopCMS3::mindphi_met_j1_j2_rl()
	{
	...
	const float &StopCMS3::mt_met_lep()
	{
	...
	const float &StopCMS3::mt_met_lep_rl()
	{
	...
	const float &StopCMS3::hadronic_top_chi2()
	{
	...
	const float &StopCMS3::ak4pfjets_rho()
	{
	...
	const float &StopCMS3::pdf_up_weight()
	{
	...
	const float &StopCMS3::pdf_down_weight()
	{
	...
	const vector<string> &StopCMS3::genweightsID()
	{
	...
	const vector<float> &StopCMS3::genweights()
	{
	...
	const float &StopCMS3::weight_btagsf()
	{
	...
	const float &StopCMS3::weight_btagsf_heavy_UP()
	{
	...
	const float &StopCMS3::weight_btagsf_light_UP()
	{
	...
	const float &StopCMS3::weight_btagsf_heavy_DN()
	{
	...
	const float &StopCMS3::weight_btagsf_light_DN()
	{
	...
	const float &StopCMS3::weight_btagsf_fastsim_UP()
	{
	...
	const float &StopCMS3::weight_btagsf_fastsim_DN()
	{
	...
	const float &StopCMS3::weight_lepSF()
	{
	...
	const float &StopCMS3::weight_lepSF_up()
	{
	...
	const float &StopCMS3::weight_lepSF_down()
	{
	...
	const float &StopCMS3::weight_vetoLepSF()
	{
	...
	const float &StopCMS3::weight_vetoLepSF_up()
	{
	...
	const float &StopCMS3::weight_vetoLepSF_down()
	{
	...
	const float &StopCMS3::weight_lepSF_fastSim()
	{
	...
	const float &StopCMS3::weight_lepSF_fastSim_up()
	{
	...
	const float &StopCMS3::weight_lepSF_fastSim_down()
	{
	...
	const float &StopCMS3::weight_ISR()
	{
	...
	const float &StopCMS3::weight_ISRup()
	{
	...
	const float &StopCMS3::weight_ISRdown()
	{
	...
	const float &StopCMS3::weight_PU()
	{
	...
	const float &StopCMS3::weight_PUup()
	{
	...
	const float &StopCMS3::weight_PUdown()
	{
	...
	const vector<string> &StopCMS3::sparms_names()
	{
	...
	const vector<float> &StopCMS3::sparms_values()
	{
	...
	const int &StopCMS3::sparms_subProcessId()
	{
	...
	const float &StopCMS3::mass_chargino()
	{
	...
	const float &StopCMS3::mass_stop()
	{
	...
	const float &StopCMS3::mass_gluino()
	{
	...
	const float &StopCMS3::genmet_phi()
	{
	...
	const bool &StopCMS3::PassTrackVeto()
	{
	...
	const bool &StopCMS3::PassTauVeto()
	{
	...
	const float &StopCMS3::topnessMod()
	{
	...
	const float &StopCMS3::topnessMod_rl()
	{
	...
	const float &StopCMS3::Mlb_closestb()
	{
	...
	const int &StopCMS3::HLT_SingleEl()
	{
	...
	const int &StopCMS3::HLT_SingleMu()
	{
	...
	const int &StopCMS3::HLT_MET100_MHT100()
	{
	...
	const int &StopCMS3::HLT_Photon90_CaloIdL_PFHT500()
	{
	...
	const int &StopCMS3::HLT_Photon22_R9Id90_HE10_IsoM()
	{
	...
	const int &StopCMS3::HLT_Photon30_R9Id90_HE10_IsoM()
	{
	...
	const int &StopCMS3::HLT_Photon36_R9Id90_HE10_IsoM()
	{
	...
	const int &StopCMS3::HLT_Photon50_R9Id90_HE10_IsoM()
	{
	...
	const int &StopCMS3::HLT_Photon75_R9Id90_HE10_IsoM()
	{
	...
	const int &StopCMS3::HLT_Photon90_R9Id90_HE10_IsoM()
	{
	...
	const int &StopCMS3::HLT_Photon120_R9Id90_HE10_IsoM()
	{
	...
	const int &StopCMS3::HLT_Photon165_R9Id90_HE10_IsoM()
	{
	...
	const int &StopCMS3::HLT_Photon175()
	{
	...
	const int &StopCMS3::HLT_Photon165_HE10()
	{
	...
	const int &StopCMS3::ph_ngoodjets()
	{
	...
	const int &StopCMS3::ph_ngoodbtags()
	{
	...
	const float &StopCMS3::hardgenpt()
	{
	...
	const float &StopCMS3::filt_badChargedCandidateFilter()
	{
	...
	const float &StopCMS3::calomet_phi()
	{
	...
	const int &StopCMS3::lep1_production_type()
	{
	...
	const float &StopCMS3::lep1_MiniIso()
	{
	...
	const float &StopCMS3::lep1_relIso()
	{
	...
	const bool &StopCMS3::lep1_passLooseID()
	{
	...
	const bool &StopCMS3::lep1_passMediumID()
	{
	...
	const bool &StopCMS3::lep1_passTightID()
	{
	...
	const bool &StopCMS3::lep1_passVeto()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &StopCMS3::lep1_p4()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &StopCMS3::lep1_mcp4()
	{
	...
	const int &StopCMS3::lep1_mc_motherid()
	{
	...
	const int &StopCMS3::lep2_production_type()
	{
	...
	const float &StopCMS3::lep2_MiniIso()
	{
	...
	const float &StopCMS3::lep2_relIso()
	{
	...
	const bool &StopCMS3::lep2_passLooseID()
	{
	...
	const bool &StopCMS3::lep2_passMediumID()
	{
	...
	const bool &StopCMS3::lep2_passTightID()
	{
	...
	const bool &StopCMS3::lep2_passVeto()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &StopCMS3::lep2_p4()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &StopCMS3::lep2_mcp4()
	{
	...
	const int &StopCMS3::lep2_mc_motherid()
	{
	...
	const vector<float> &StopCMS3::ph_sigmaIEtaEta_fill5x5()
	{
	...
	const vector<float> &StopCMS3::ph_hOverE()
	{
	...
	const vector<float> &StopCMS3::ph_r9()
	{
	...
	const vector<float> &StopCMS3::ph_chiso()
	{
	...
	const vector<float> &StopCMS3::ph_nhiso()
	{
	...
	const vector<float> &StopCMS3::ph_phiso()
	{
	...
	const vector<bool> &StopCMS3::ph_idCutBased()
	{
	...
	const vector<int> &StopCMS3::ph_overlapJetId()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopCMS3::ph_p4()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopCMS3::ph_mcp4()
	{
	...
	const vector<float> &StopCMS3::ph_pt()
	{
	...
	const vector<float> &StopCMS3::ph_eta()
	{
	...
	const vector<float> &StopCMS3::ph_phi()
	{
	...
	const vector<float> &StopCMS3::ph_mass()
	{
	...
	const vector<int> &StopCMS3::ph_mcMatchId()
	{
	...
	const vector<float> &StopCMS3::ph_genIso04()
	{
	...
	const vector<float> &StopCMS3::ph_drMinParton()
	{
	...
	const float &StopCMS3::ak4_htratiom()
	{
	...
	const vector<float> &StopCMS3::dphi_ak4pfjet_met()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopCMS3::ak4pfjets_p4()
	{
	...
	const vector<bool> &StopCMS3::ak4pfjets_passMEDbtag()
	{
	...
	const vector<float> &StopCMS3::ak4pfjets_CSV()
	{
	...
	const vector<float> &StopCMS3::ak4pfjets_mva()
	{
	...
	const vector<int> &StopCMS3::ak4pfjets_parton_flavor()
	{
	...
	const vector<int> &StopCMS3::ak4pfjets_hadron_flavor()
	{
	...
	const vector<bool> &StopCMS3::ak4pfjets_loose_puid()
	{
	...
	const vector<bool> &StopCMS3::ak4pfjets_loose_pfid()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &StopCMS3::ak4pfjets_leadMEDbjet_p4()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &StopCMS3::ak4pfjets_leadbtag_p4()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopCMS3::ak4genjets_p4()
	{
	...
	const vector<bool> &StopCMS3::genleps_isfromt()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopCMS3::genleps_p4()
	{
	...
	const vector<int> &StopCMS3::genleps_id()
	{
	...
	const vector<int> &StopCMS3::genleps__genpsidx()
	{
	...
	const vector<int> &StopCMS3::genleps_status()
	{
	...
	const vector<bool> &StopCMS3::genleps_fromHardProcessDecayed()
	{
	...
	const vector<bool> &StopCMS3::genleps_fromHardProcessFinalState()
	{
	...
	const vector<bool> &StopCMS3::genleps_isHardProcess()
	{
	...
	const vector<bool> &StopCMS3::genleps_isLastCopy()
	{
	...
	const vector<int> &StopCMS3::genleps_gentaudecay()
	{
	...
	const int &StopCMS3::gen_nfromtleps_()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopCMS3::genleps_motherp4()
	{
	...
	const vector<int> &StopCMS3::genleps_motherid()
	{
	...
	const vector<int> &StopCMS3::genleps_motheridx()
	{
	...
	const vector<int> &StopCMS3::genleps_motherstatus()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopCMS3::genleps_gmotherp4()
	{
	...
	const vector<int> &StopCMS3::genleps_gmotherid()
	{
	...
	const vector<int> &StopCMS3::genleps_gmotheridx()
	{
	...
	const vector<int> &StopCMS3::genleps_gmotherstatus()
	{
	...
	const vector<bool> &StopCMS3::gennus_isfromt()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopCMS3::gennus_p4()
	{
	...
	const vector<int> &StopCMS3::gennus_id()
	{
	...
	const vector<int> &StopCMS3::gennus__genpsidx()
	{
	...
	const vector<int> &StopCMS3::gennus_status()
	{
	...
	const vector<bool> &StopCMS3::gennus_fromHardProcessDecayed()
	{
	...
	const vector<bool> &StopCMS3::gennus_fromHardProcessFinalState()
	{
	...
	const vector<bool> &StopCMS3::gennus_isHardProcess()
	{
	...
	const vector<bool> &StopCMS3::gennus_isLastCopy()
	{
	...
	const vector<int> &StopCMS3::gennus_gentaudecay()
	{
	...
	const int &StopCMS3::gen_nfromtnus_()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopCMS3::gennus_motherp4()
	{
	...
	const vector<int> &StopCMS3::gennus_motherid()
	{
	...
	const vector<int> &StopCMS3::gennus_motheridx()
	{
	...
	const vector<int> &StopCMS3::gennus_motherstatus()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopCMS3::gennus_gmotherp4()
	{
	...
	const vector<int> &StopCMS3::gennus_gmotherid()
	{
	...
	const vector<int> &StopCMS3::gennus_gmotheridx()
	{
	...
	const vector<int> &StopCMS3::gennus_gmotherstatus()
	{
	...
	const vector<bool> &StopCMS3::genqs_isfromt()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopCMS3::genqs_p4()
	{
	...
	const vector<int> &StopCMS3::genqs_id()
	{
	...
	const vector<int> &StopCMS3::genqs__genpsidx()
	{
	...
	const vector<int> &StopCMS3::genqs_status()
	{
	...
	const vector<bool> &StopCMS3::genqs_fromHardProcessDecayed()
	{
	...
	const vector<bool> &StopCMS3::genqs_fromHardProcessFinalState()
	{
	...
	const vector<bool> &StopCMS3::genqs_isHardProcess()
	{
	...
	const vector<bool> &StopCMS3::genqs_isLastCopy()
	{
	...
	const vector<int> &StopCMS3::genqs_gentaudecay()
	{
	...
	const int &StopCMS3::gen_nfromtqs_()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopCMS3::genqs_motherp4()
	{
	...
	const vector<int> &StopCMS3::genqs_motherid()
	{
	...
	const vector<int> &StopCMS3::genqs_motheridx()
	{
	...
	const vector<int> &StopCMS3::genqs_motherstatus()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopCMS3::genqs_gmotherp4()
	{
	...
	const vector<int> &StopCMS3::genqs_gmotherid()
	{
	...
	const vector<int> &StopCMS3::genqs_gmotheridx()
	{
	...
	const vector<int> &StopCMS3::genqs_gmotherstatus()
	{
	...
	const vector<bool> &StopCMS3::genbosons_isfromt()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopCMS3::genbosons_p4()
	{
	...
	const vector<int> &StopCMS3::genbosons_id()
	{
	...
	const vector<int> &StopCMS3::genbosons__genpsidx()
	{
	...
	const vector<int> &StopCMS3::genbosons_status()
	{
	...
	const vector<bool> &StopCMS3::genbosons_fromHardProcessDecayed()
	{
	...
	const vector<bool> &StopCMS3::genbosons_fromHardProcessFinalState()
	{
	...
	const vector<bool> &StopCMS3::genbosons_isHardProcess()
	{
	...
	const vector<bool> &StopCMS3::genbosons_isLastCopy()
	{
	...
	const vector<int> &StopCMS3::genbosons_gentaudecay()
	{
	...
	const int &StopCMS3::gen_nfromtbosons_()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopCMS3::genbosons_motherp4()
	{
	...
	const vector<int> &StopCMS3::genbosons_motherid()
	{
	...
	const vector<int> &StopCMS3::genbosons_motheridx()
	{
	...
	const vector<int> &StopCMS3::genbosons_motherstatus()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopCMS3::genbosons_gmotherp4()
	{
	...
	const vector<int> &StopCMS3::genbosons_gmotherid()
	{
	...
	const vector<int> &StopCMS3::genbosons_gmotheridx()
	{
	...
	const vector<int> &StopCMS3::genbosons_gmotherstatus()
	{
	...
	const vector<bool> &StopCMS3::gensusy_isfromt()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopCMS3::gensusy_p4()
	{
	...
	const vector<int> &StopCMS3::gensusy_id()
	{
	...
	const vector<int> &StopCMS3::gensusy__genpsidx()
	{
	...
	const vector<int> &StopCMS3::gensusy_status()
	{
	...
	const vector<bool> &StopCMS3::gensusy_fromHardProcessDecayed()
	{
	...
	const vector<bool> &StopCMS3::gensusy_fromHardProcessFinalState()
	{
	...
	const vector<bool> &StopCMS3::gensusy_isHardProcess()
	{
	...
	const vector<bool> &StopCMS3::gensusy_isLastCopy()
	{
	...
	const vector<int> &StopCMS3::gensusy_gentaudecay()
	{
	...
	const int &StopCMS3::gen_nfromtsusy_()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopCMS3::gensusy_motherp4()
	{
	...
	const vector<int> &StopCMS3::gensusy_motherid()
	{
	...
	const vector<int> &StopCMS3::gensusy_motheridx()
	{
	...
	const vector<int> &StopCMS3::gensusy_motherstatus()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopCMS3::gensusy_gmotherp4()
	{
	...
	const vector<int> &StopCMS3::gensusy_gmotherid()
	{
	...
	const vector<int> &StopCMS3::gensusy_gmotheridx()
	{
	...
	const vector<int> &StopCMS3::gensusy_gmotherstatus()
	{
	...
	const vector<TString> &StopCMS3::tau_IDnames()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopCMS3::tau_leadtrack_p4()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopCMS3::tau_leadneutral_p4()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopCMS3::tau_p4()
	{
	...
	const vector<vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > > &StopCMS3::tau_isocand_p4()
	{
	...
	const vector<vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > > &StopCMS3::tau_sigcand_p4()
	{
	...
	const vector<vector<float> > &StopCMS3::tau_ID()
	{
	...
	const vector<float> &StopCMS3::tau_passID()
	{
	...
	const vector<float> &StopCMS3::tau_againstMuonTight()
	{
	...
	const vector<float> &StopCMS3::tau_againstElectronLoose()
	{
	...
	const vector<bool> &StopCMS3::tau_isVetoTau()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopCMS3::isoTracks_p4()
	{
	...
	const vector<int> &StopCMS3::isoTracks_charge()
	{
	...
	const vector<float> &StopCMS3::isoTracks_absIso()
	{
	...
	const vector<float> &StopCMS3::isoTracks_dz()
	{
	...
	const vector<int> &StopCMS3::isoTracks_pdgId()
	{
	...
	const vector<bool> &StopCMS3::isoTracks_isVetoTrack()
	{
	...
	const vector<bool> &StopCMS3::isoTracks_isVetoTrack_v2()
	{
	...
	const vector<bool> &StopCMS3::isoTracks_isVetoTrack_v3()
	{
  ...
  void StopCMS3::progress( int nEventsTotal, int nEventsChain ){
    int period = 1000;
...
namespace stoptas {
	...
	const float &pfmet_rl() { return stopcms3.pfmet_rl(); }
	const float &pfmet_phi_rl() { return stopcms3.pfmet_phi_rl(); }
	const float &scale1fb() { return stopcms3.scale1fb(); }
	const float &xsec() { return stopcms3.xsec(); }
	const float &xsec_uncert() { return stopcms3.xsec_uncert(); }
	...
	const float &MT2W_rl() { return stopcms3.MT2W_rl(); }
	const float &mindphi_met_j1_j2() { return stopcms3.mindphi_met_j1_j2(); }
	const float &mindphi_met_j1_j2_rl() { return stopcms3.mindphi_met_j1_j2_rl(); }
	const float &mt_met_lep() { return stopcms3.mt_met_lep(); }
	const float &mt_met_lep_rl() { return stopcms3.mt_met_lep_rl(); }
	const float &hadronic_top_chi2() { return stopcms3.hadronic_top_chi2(); }
	const float &ak4pfjets_rho() { return stopcms3.ak4pfjets_rho(); }
	const float &pdf_up_weight() { return stopcms3.pdf_up_weight(); }
	const float &pdf_down_weight() { return stopcms3.pdf_down_weight(); }
	const vector<string> &genweightsID() { return stopcms3.genweightsID(); }
	const vector<float> &genweights() { return stopcms3.genweights(); }
	const float &weight_btagsf() { return stopcms3.weight_btagsf(); }
	const float &weight_btagsf_heavy_UP() { return stopcms3.weight_btagsf_heavy_UP(); }
	const float &weight_btagsf_light_UP() { return stopcms3.weight_btagsf_light_UP(); }
	const float &weight_btagsf_heavy_DN() { return stopcms3.weight_btagsf_heavy_DN(); }
	const float &weight_btagsf_light_DN() { return stopcms3.weight_btagsf_light_DN(); }
	const float &weight_btagsf_fastsim_UP() { return stopcms3.weight_btagsf_fastsim_UP(); }
	const float &weight_btagsf_fastsim_DN() { return stopcms3.weight_btagsf_fastsim_DN(); }
	const float &weight_lepSF() { return stopcms3.weight_lepSF(); }
	const float &weight_lepSF_up() { return stopcms3.weight_lepSF_up(); }
	const float &weight_lepSF_down() { return stopcms3.weight_lepSF_down(); }
	const float &weight_vetoLepSF() { return stopcms3.weight_vetoLepSF(); }
	const float &weight_vetoLepSF_up() { return stopcms3.weight_vetoLepSF_up(); }
	const float &weight_vetoLepSF_down() { return stopcms3.weight_vetoLepSF_down(); }
	const float &weight_lepSF_fastSim() { return stopcms3.weight_lepSF_fastSim(); }
	const float &weight_lepSF_fastSim_up() { return stopcms3.weight_lepSF_fastSim_up(); }
	const float &weight_lepSF_fastSim_down() { return stopcms3.weight_lepSF_fastSim_down(); }
	const float &weight_ISR() { return stopcms3.weight_ISR(); }
	const float &weight_ISRup() { return stopcms3.weight_ISRup(); }
	const float &weight_ISRdown() { return stopcms3.weight_ISRdown(); }
	const float &weight_PU() { return stopcms3.weight_PU(); }
	const float &weight_PUup() { return stopcms3.weight_PUup(); }
	const float &weight_PUdown() { return stopcms3.weight_PUdown(); }
	...
	const float &mass_gluino() { return stopcms3.mass_gluino(); }
	...
	const float &topnessMod_rl() { return stopcms3.topnessMod_rl(); }
	...
	const int &HLT_MET() { return stopcms3.HLT_MET(); }
	const int &HLT_MET100_MHT100() { return stopcms3.HLT_MET100_MHT100(); }
	const int &HLT_DiEl() { return stopcms3.HLT_DiEl(); }
	const int &HLT_DiMu() { return stopcms3.HLT_DiMu(); }
	const int &HLT_MuE() { return stopcms3.HLT_MuE(); }
	const int &HLT_Photon90_CaloIdL_PFHT500() { return stopcms3.HLT_Photon90_CaloIdL_PFHT500(); }
	const int &HLT_Photon22_R9Id90_HE10_IsoM() { return stopcms3.HLT_Photon22_R9Id90_HE10_IsoM(); }
	const int &HLT_Photon30_R9Id90_HE10_IsoM() { return stopcms3.HLT_Photon30_R9Id90_HE10_IsoM(); }
	const int &HLT_Photon36_R9Id90_HE10_IsoM() { return stopcms3.HLT_Photon36_R9Id90_HE10_IsoM(); }
	const int &HLT_Photon50_R9Id90_HE10_IsoM() { return stopcms3.HLT_Photon50_R9Id90_HE10_IsoM(); }
	const int &HLT_Photon75_R9Id90_HE10_IsoM() { return stopcms3.HLT_Photon75_R9Id90_HE10_IsoM(); }
	const int &HLT_Photon90_R9Id90_HE10_IsoM() { return stopcms3.HLT_Photon90_R9Id90_HE10_IsoM(); }
	const int &HLT_Photon120_R9Id90_HE10_IsoM() { return stopcms3.HLT_Photon120_R9Id90_HE10_IsoM(); }
	...
	const float &hardgenpt() { return stopcms3.hardgenpt(); }
	const float &filt_badChargedCandidateFilter() { return stopcms3.filt_badChargedCandidateFilter(); }
	...
	const float &lep1_relIso() { return stopcms3.lep1_relIso(); }
	const bool &lep1_passLooseID() { return stopcms3.lep1_passLooseID(); }
	const bool &lep1_passMediumID() { return stopcms3.lep1_passMediumID(); }
	const bool &lep1_passTightID() { return stopcms3.lep1_passTightID(); }
	...
	const int &lep1_mc_motherid() { return stopcms3.lep1_mc_motherid(); }
	...
	const float &lep2_relIso() { return stopcms3.lep2_relIso(); }
	const bool &lep2_passLooseID() { return stopcms3.lep2_passLooseID(); }
	const bool &lep2_passMediumID() { return stopcms3.lep2_passMediumID(); }
	const bool &lep2_passTightID() { return stopcms3.lep2_passTightID(); }
	...
	const int &lep2_mc_motherid() { return stopcms3.lep2_mc_motherid(); }
	...
	const vector<float> &ak4pfjets_mva() { return stopcms3.ak4pfjets_mva(); }
	const vector<int> &ak4pfjets_parton_flavor() { return stopcms3.ak4pfjets_parton_flavor(); }
	const vector<int> &ak4pfjets_hadron_flavor() { return stopcms3.ak4pfjets_hadron_flavor(); }
